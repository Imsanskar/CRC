...
const char *pad_dividend(char dividend[], int dividend_len, int divisor_len)
{
  ...
  char *new_dividend = new char[new_dividend_length + 1]; // + 2

  strcpy(new_dividend, dividend);
  memset(new_dividend + dividend_len, '0', divisor_len - 1); // divisor
                    ...
                    int dividend_len, int divisor_len)
{
  ...
  while (pick < dividend_len+divisor_len-1)
  {
...
//int main(){
//  char dividend[] = "0100100001100101011011000110110001101111";
//  char divisor[] = "10101";
